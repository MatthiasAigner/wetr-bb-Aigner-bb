...
namespace DAL.Client {
    ...
    class Program {
        ...
        private static void Main() {            
            ...
            measurementTester.TestInsertMeasurement(new Measurements("ENNS", "11.11.2018 12:00:32",20.9, 955.8, 5.5, 56.7, 1.2,"South"));
        ...
        private static void InsertALotOfMeasurments()
        {
            ...
            for (long i = 0; i < 1000000; i++)
            {
                ...
                Measurements m = new Measurements("Station", "randomDate",airTemp, airpressure, rainfall, humidity, windspeed, windDirection);
